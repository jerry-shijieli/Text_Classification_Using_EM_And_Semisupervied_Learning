...
if opts.use_hashing:
    ...
    X_train = vectorizer.transform(data_trian.data)
else:
...
print("n_samplles: %d, n_features: %d" % X_test.shape)
print()
...
if opts.select_chi2:
    ...
    if feature_names:
        ...
        features_names = [feature_names[i] for i in ch2.get_support(indices=True)]
...
def trim(s):
    """Trim string to fit on terminal (assumming 80-column display)"""
...
# The more regulariation, the more sparsity.
